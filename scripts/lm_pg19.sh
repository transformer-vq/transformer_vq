...
Help() {
  echo "Syntax: lm_pg19.sh [x|c|r|p|t|l|m|s|a|g|e|i|o|d|v|w|h]"
  echo "options:"
  ...
  echo "v     Vocab path: local path or GCS path."
...
MULTIHOST=0;
while getopts "xc:r:p:t:l:m:s:a:g:e:i:o:d:v:w:h" option; do
  case $option in
    x)
      MULTIHOST=1;;
    c)
...
python3 scripts/launch.py \
  ...
  --model_name=transformer_vq_pg19 \
  --run_id="$WB_RUN_ID"
